<template>
  <div class="bgMusic">
    <!-- 音乐播放器 -->
    <div>
        <audio :autoplay="true" :controls="true" :loop="true" ref="warningMusic" muted preload webkit-playsinline="true"  playsinline="true"  id="audio">
...
export default {
  ...
  mounted(){
    ...
    //   _this.audioAutoPlay();//手动播放音乐
    //   _this.audioAutoPlay1();//手动播放音乐1
