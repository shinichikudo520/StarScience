    ...
    <div class="middle">
        ...
        <div class="tab">
            <div class="rechargeQrcode"  >
                ...
                <p style="font-size:12px;text-align:center;color:red; display:none">长按保存二维码</p>
  ...
  methods:{  
    ...
    //   },
      //显示充值确认模态框
        ...
        getQRcode(){
            let  _this = this;
            let api = '/company_address';
            _this.axios.post(api,{
                uid:_this.$store.state.uid
            }).then(res=>{
                //console.log(res);
                let address = res.data.company_address
                //获取二维码图片路径
