...
import risk from '@/components/risk'//用户风控
import userHierarchy from '@/components/userHierarchy'//用户层级
...
import manageCommodity from '@/components/manageCommodity'
    ...
    {//后台管理
        ...
        children:[//1. 路由嵌套，声明children数组存储配置子路由
            ...
            // userHierarchy：用户层级图
            {
                path:"/userHierarchy",
                name: 'userHierarchy',
                component:userHierarchy,//3.引入子路由组件
                meta:{
                    adminAuth:true,//验证是否需要登陆状态，false不需要
                }, 
            },
            ...
            {//管理商品
                ...
                component:manageCommodity,//3.引入子路由组件
                meta:{
                    adminAuth:true,//验证是否需要登陆状态，false不需要
                }, 
            },
