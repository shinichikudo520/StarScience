  ...
  <div class="agentHome">
      ...
      <div class="pwdSetting">
          ...
          <div class="loginPwd">
            ...
            <div class="getCode" v-if="!isVerifyLogin" @click="getCode(0)"><span class="dis">获取</span>验证码</div>
            <!-- 60s验证 -->
          ...
          <div class="payPwd">
            ...
            <div class="getCode" v-if="!isVerifyPay" @click="getCode(1)"><span class="dis">获取</span>验证码</div>
            <!-- 60s验证 -->
...
@media screen and (max-width:768px){
    ...
    /* table 第二个td */
    .agentHome>>>table td:nth-child(2){
        width: 60%;
    }
    .agentHome>>>input{
        font-size: .625rem;
    ...
    /* 第三个td */
    .agentHome>>>table td:nth-child(3){
        padding-left: .5rem;
    }
    /* 密码管理 */
    .agentHome>>>.loginPwd, .payPwd{
    ...
    .agentHome>>>.loginPwd button,.payPwd button{
        ...
        background-color: rgba(68, 126, 217, 1) !important;
        margin: .625rem auto;
    }
}
</style>
