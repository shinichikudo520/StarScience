  ...
  <div class="manageCrowdfunding">
      ...
      <div class="havedProduct">
            <div class="havedProductItem" v-for="(item,index) in product" :key="index">
                ...
                <div class="productInfo">
                    <p><el-input v-model="item.productName" :disabled="item.readOnly" placeholder="请输入内容" class="product"></el-input> </p>
                    <p><el-input v-model="item.productNum"  :disabled="item.readOnly" placeholder="请输入内容" class="product productNum"></el-input></p>
                </div>
      ...
      <div class="appendProduct" v-if="isAppendProduct">
        <div class="appendProductItem">
            ...
            <div class="productInfo">
                <p><el-input v-model="product[0].productName" :disabled="false" placeholder="请输入内容" class="product"></el-input> </p>
                <p><el-input v-model="product[0].productNum" :disabled="false" placeholder="请输入内容" class="product productNum"></el-input></p>
            </div>
            <div class="operateBtn">
...
export default {
  ...
  data () {
    return {
        product:[
            {
                productImg:require('../assets/img/product4.jpg'),//产品图片
                productName:'Raise Your Glass',//产品名称
                // productLevel:'v1',//产品等级
                productNum:'一季单曲',//产品数量
                readOnly:true,//只读属性
                redact:"编辑",//
            },
            {
                productImg:require('../assets/img/product5.jpg'),//产品图片
                productName:'Bilinçaltı',//产品名称
                // productLevel:'v2',//产品等级
                productNum:'双季专辑',//产品数量
                readOnly:true,//只读属性
                redact:"编辑",//
            },
            {
                productImg:require('../assets/img/product6.jpg'),//产品图片
                productName:"提斯·米希尔·韦尔威斯特（Tiësto）",//产品名称
                // productLevel:'v3',//产品等级
                productNum:'年度红人',//产品数量
                readOnly:true,//只读属性
                redact:"编辑",//
            },
        ],//产品
...
/* 产品信息部分 */
.manageCrowdfunding>>>.productInfo{
    margin-right: 20%;
}
/* 产品模板下的输入框 */
...
.manageCrowdfunding>>>.havedProductItem .el-input__inner,.appendProductItem .el-input__inner{   
...
/* 产品名称 */
.manageCrowdfunding>>>.product input{
...
/* 产品类型 */
.manageCrowdfunding>>>.productType input{
    color: rgba(68, 126, 217, 1);
    font-weight: 400;
    font-size: .875rem;
}
/* 产品数量 */
.manageCrowdfunding>>>.productNum input{
    font-weight: 400;
}
/* 添加按钮 */
.manageCrowdfunding>>>.appendBtn{
    width: 80%;
    margin: 0 auto;
    text-align: center;
}
.manageCrowdfunding>>>.appendBtn button{
